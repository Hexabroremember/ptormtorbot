    ...
    faqItems: [
      {
        ...
        paragraphs: [
          "בישראל משתמשים במושג ״פטור מתור״ במצבים שבהם יש אישור או זכאות שלא להמתין בתור רגיל, בהתאם למסמך או לאישור שקיבלתם.",
          "המיני־אפ לא בודק זכאות ולא מנפיק אישור רשמי מטעם גוף ממשלתי. הוא פשוט יוצר עבורכם גרסה דיגיטלית מסודרת ונוחה עם הפרטים שהזנתם.",
          "אפשר להציג את האישור במקומות רבים — דוגמאות בתשובה הבאה.",
        ],
      },
      {
      ...
      },
      {
        q: "למה זה שימושי?",
        paragraphs: [
          "כי הכול נמצא אצלכם בטלפון, זמין תוך שניות ובלי להתחיל לחפש מסמכים כל פעם מחדש 😄",
        ],
        bullets: [
          "הורדה מיידית של PDF",
          "שמירה נוחה בטלפון",
          "אפשר להוריד שוב מתי שרוצים",
      ...
      },
      {
        ...
        paragraphs: [
          "כן 😄 כל ההנפקות נשמרות באזור הרכישות, כך שאפשר לחזור ולהוריד שוב מתי שרוצים.",
        ],
      },
      {
        q: "כמה זמן לוקח להפיק תעודה?",
        paragraphs: [
          "בדרך כלל פחות מכמה דקות. ממלאים פרטים, מאשרים, ומקבלים קובץ מוכן.",
        ],
      },
      {
        q: "אפשר להשתמש בתעודה גם בחו״ל?",
        paragraphs: [
          "כן 🌍 התעודה מגיעה בפורמט PDF דיגיטלי סטנדרטי, עם השם באנגלית כפי שהזנתם — כך שניתן להציג אותה או לשלוח אותה גם מחוץ לישראל, בכל מקום שמקבלים מסמך דיגיטלי רגיל. בהתאם למדיניות המקומית או לדרישות הגורם שאליו אתם פונים, עשויים להיות הבדלים — מומלץ לוודא מראש שהפורמט והפרטים מתאימים לצורך שלכם.",
        ],
      },
    ],
  },
    ...
    faqItems: [
      {
        ...
        paragraphs: [
          "في إسرائيل يُستخدم مصطلح «إعفاء من الطابور» في حالات يكون فيها لديكم إذن أو أهلية لعدم الانتظار في طابور عادي، وفقًا لمستند أو إذن تلقيتموه.",
          "التطبيق المصغّر لا يتحقق من الأهلية ولا يصدر إذنًا رسميًا من جهة حكومية. هو ببساطة ينشئ نسخة رقمية مرتبة ومريحة بالبيانات التي أدخلتموها.",
          "يمكن عرض الإذن في أماكن كثيرة — أمثلة في الإجابة التالية.",
        ],
      },
      {
      ...
      },
      {
        q: "لماذا هذا مفيد؟",
        paragraphs: [
          "لأن كل شيء لديكم على الهاتف، متاح خلال ثوانٍ ودون البحث عن المستندات في كل مرة 😄",
        ],
        bullets: [
          "تنزيل فوري لملف PDF",
          "حفظ مريح على الهاتف",
          "إمكانية التنزيل مجددًا متى شئتم",
      ...
      },
      {
        ...
        paragraphs: [
          "نعم 😄 تُحفظ جميع الإصدارات في منطقة المشتريات، ويمكنكم العودة والتنزيل متى شئتم.",
        ],
      },
      {
        q: "كم يستغرق إصدار الوثيقة؟",
        paragraphs: [
          "عادة أقل من بضع دقائق. تملأون البيانات، تؤكدون، وتتلقون ملفًا جاهزًا.",
        ],
      },
      {
        q: "هل يمكن استخدام الوثيقة في الخارج أيضًا؟",
        paragraphs: [
          "نعم 🌍 تصل الوثيقة بصيغة PDF رقمية قياسية، مع الاسم بالإنجليزية كما أدخلتموه — ويمكن عرضها أو إرسالها خارج إسرائيل أيضًا، حيثما يُقبل مستند رقمي عادي. وفقًا للسياسة المحلية أو متطلبات الجهة التي تتوجهون إليها قد تختلف التفاصيل — يُنصح بالتأكد مسبقًا أن الصيغة والبيانات تناسب احتياجكم.",
        ],
      },
    ],
  },
