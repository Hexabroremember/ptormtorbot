...
From the **repository root**, use the skill-relative path (this skill lives under `.cursor/skills/code-reviewer/`):

```bash
python .cursor/skills/code-reviewer/scripts/pr_analyzer.py <project-path> [options]
python .cursor/skills/code-reviewer/scripts/code_quality_checker.py <target-path> [--verbose]
python .cursor/skills/code-reviewer/scripts/review_report_generator.py <target-path> [options]
```
...
# Analysis (from repo root; scripts live under .cursor/skills/code-reviewer/)
python .cursor/skills/code-reviewer/scripts/code_quality_checker.py .
python .cursor/skills/code-reviewer/scripts/review_report_generator.py .
